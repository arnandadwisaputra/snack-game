...
function update() {
    ...
    if (gameOver) {
        ...
        createText(`Your Score: ${score}`, board.width / 2, board.height / 2 + 25, 'center');

        createText(`Click to Start Again`, (cols * blockSize) / 2, board.height - 100, 'center');

        createText('Back Home',(cols * blockSize) / 2, board.height - 50, 'center')
